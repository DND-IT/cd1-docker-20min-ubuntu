...
ARG PERL5_DEBUG_HOST=docker.for.mac.localhost
ARG PERL5_DEBUG_PORT=12345
ARG PERL5_DEBUG_ROLE=client

ENV PERL5_DEBUG_HOST=$PERL_DEBUG_HOST
ENV PERL5_DEBUG_PORT=$PERL5_DEBUG_PORT
ENV PERL5_DEBUG_ROLE=$PERL5_DEBUG_ROLE
